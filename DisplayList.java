...
public class DisplayList {
  ...
  // moves the Entity at the argument index back one index (ex: from index idx to
  // idx - 1)
  ...
  // moves the Entity at the argument index forward one index (ex: from index idx
  // to idx + 1)
  ...
  // moves the Entity at the argument index to the start (i.e.: index 0) of the
  // DisplayList
  ...
  // moves the Entity at the argument index to the end (i.e.: index size-1) of the
  // DisplayList
