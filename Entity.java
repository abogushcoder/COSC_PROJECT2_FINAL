...
public abstract class Entity {
  ...
  // This rectangle is also its "hitbox", governing its boundaries when
  ...
  // Determines if the Entitiy is flagged to be garbage collected (true) or not
  // (false)
  ...
  // if flagged for garbage collection, the Entity will be removed from the
  // DisplayList
  ...
  // returns a boolean indicating if this Entity is flagged to be garbage
